    ...
    <div class="row">
        <div class="col-8">
            ...
            <?php
                ...
                $cid=$row['category_id'];
                echo "<h4 class'margin-bottom-15 question-title'>Questions : ".$row['title']."</h4>
                <p class='margin-bottom-15'>".$row['description']."</p>";
                include ("answers.php");
            ?>
            <form action="./server/requests.php" method="post">
                <input type="hidden" name="question_id" value="<?php echo $qid ?>">
                <textarea name="answer" class="form-control margin-bottom-15 desc" placeholder="Your answer here..."></textarea>
